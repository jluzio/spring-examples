package com.example.spring.batch.playground.user_posts.api;
...
import com.example.spring.batch.playground.user_posts.api.model.ImportCsvFileJobRequest;
import com.example.spring.batch.playground.user_posts.api.model.ImportDataJobRequest;
import com.example.spring.batch.playground.user_posts.batch.JobParameters;
import com.example.spring.batch.playground.user_posts.config.UserBatchConfig;
...
public class UserJobController {
  ...
  public JobStatusResponse importCsvFileJob(@RequestBody ImportCsvFileJobRequest request) throws JobExecutionException {
    ...
    var jobExecution = jobLauncher.run(userImportCsvFileJob, jobParameters);
  ...
  public JobStatusResponse importDataJob(@RequestBody ImportDataJobRequest request)
    ...
    var jobExecution = jobLauncher.run(userImportDataJob, jobParameters);
