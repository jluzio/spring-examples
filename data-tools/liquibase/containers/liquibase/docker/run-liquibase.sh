...
# version 3.x
#cmd="docker run --rm -v $lb_files/changelog:/liquibase/changelog -v $lb_files/classpath:/liquibase/classpath --add-host=bridge.docker:host-gateway liquibase/liquibase:3.10.3 '--defaultsFile=/liquibase/changelog/liquibase.docker.properties' $1"
powershell -c $cmd
