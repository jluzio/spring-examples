...
public class CustomCodeGrantAuthenticationProvider implements AuthenticationProvider {
  ...
  public Authentication authenticate(Authentication authentication) throws AuthenticationException {
    var customCodeGrantAuthentication = (CustomCodeGrantAuthenticationToken) authentication;
    ...
    // TODO Better validation for the code parameter
    if (!Objects.equals(customCodeGrantAuthentication.getCode(), "42")) {
