...
public class RepositoryTest {
  ...
  void test() {
    ...
    var findByNameAndMail = repository.findByNameIgnoreCaseAndEmailIgnoreCase("NAMe-1", "nAmE-1@mail.org");
    ...
    var nameSlice = repository.findByNameContaining("name", PageRequest.of(1, 2, Direction.DESC, "id"));
    ...
    var nativeResult = repository.findByEmailAddressContaningNative("mail.org", PageRequest.of(1, 2, Direction.DESC, "id"));
