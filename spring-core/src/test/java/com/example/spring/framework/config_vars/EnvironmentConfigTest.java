...
import com.example.spring.framework.config_vars.EnvironmentConfigTest.TestProps;
...
class EnvironmentConfigTest {
  ...
  private String testPropsComplexKeyNameCorrect;
  @Value("${test-props.ComplexKeyName}")
  private String testPropsComplexKeyNameIncorrect;
  @Value("${test-props.complexKeyName}")
  private String testPropsComplexKeyNameIncorrect2;
  ...
  void var_source_priority() {
    ...
    assertThat(testPropsComplexKeyNameCorrect)
        .isEqualTo("env-complexKeyName");
    assertThat(testPropsComplexKeyNameIncorrect)
        .isEqualTo("${test-props.ComplexKeyName}");
    assertThat(testPropsComplexKeyNameIncorrect2)
        .isEqualTo("${test-props.complexKeyName}");
  }
